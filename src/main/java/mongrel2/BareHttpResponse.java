...
/**
 * Bare HTTP response object used to return responses to the Mongrel2 web
 * server; slightly modelled after HttpServletResponse of the Servlet API.
 * 
 * @author Karl Ostendorf
 * 
 */
public class BareHttpResponse extends Response {
